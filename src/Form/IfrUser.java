...
public class IfrUser extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmbLevUser.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih --", "Administator" }));
...
//Penjelasan
/*
    Ingat! Setiap kali kalian akan melakukan typing sintak program pada form,
    langkah pertama kalian harus memastikan sudah mendeklarasikan variabel name
    pada masing2 komponen yang ada pada form.
    Jadi, langkah2nya :
    1. Deklarasi variable name setiap komponen pada form
    2. Import file class library java yang dibutuhkan
    3. Buat objek untuk koneksi database
    4. Deklarasikan variabel2 yang dibutuhkan untuk membantu dalam oprasi form user ini
    5. Buat method2 yang dibutuhkan untuk mempermudah oprasi pada form user
    6. Memberikan event pada button dan table
